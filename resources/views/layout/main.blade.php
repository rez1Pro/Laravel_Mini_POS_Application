...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="/users" data-toggle="collapse" data-target="#collapseOne"
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <button type="button" class="btn btn-primary float-right" data-toggle="modal"
                        data-target="#@yield('data-target')">
                        @yield('modal-button')
                    </button>
                    <!-- Modal -->
                    <div class="modal fade" id="@yield('target-id')" tabindex="-1" role="dialog"
